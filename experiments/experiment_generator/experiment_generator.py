...
class ExperimentGenerator():
    ...
    def __init__(self, number_experiments, number_services, length_vnf, experiment_path):
    ...
    def generate_experiment(self):
        for experiment in range(self.number_of_experiments):
            ...
            with open(self.path + 'experiment_' + str(experiment) + '.json', 'w') as json_file:
                ...
                self.generate_migration_paramerer(migration_indexes, experiment)
                json.dump(experiment, json_file)

    def generate_migration_paramerer(self, migration_indexes, experiment):
        migration = []
        vnf_index = 0
    ...
    def generate_random_vector(self):
        ...
        variance = 1
        return np.random.normal(standard_deviation, variance, self.number_of_vnf)
...
def main():
    ...
    exp_gen = ExperimentGenerator(number_of_experiments, number_of_services, length_of_vnfs, experiment_path)
    exp_gen.generate_experiment()
