...
# Launch orchestrator
python orchestrator_script.py -i 4 -e 1 &
...
python vnf_script.py -i 0 -o 4 -e 1 &
python vnf_script.py -i 1 -o 4 -e 1 &
python vnf_script.py -i 2 -o 4 -e 1 &
python vnf_script.py -i 3 -o 4 -e 1 &
python vnf_script.py -i 4 -o 4 -e 1 &
