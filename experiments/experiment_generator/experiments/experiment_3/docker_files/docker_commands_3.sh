...
# Launch orchestrator
python orchestrator_script.py -i 3 -e 3 &
...
python vnf_script.py -i 0 -o 3 -e 3 &
python vnf_script.py -i 1 -o 3 -e 3 &
python vnf_script.py -i 2 -o 3 -e 3 &
python vnf_script.py -i 3 -o 3 -e 3 &
python vnf_script.py -i 4 -o 3 -e 3 &
