...
# Launch orchestrator
python orchestrator_script_normal.py -i 4 -e 3 -h '0.0.0.0' -p 5005 -r 785923 &
...
# Request scaling 
python message_factory.py -t request_scaling_of_service -h 52.141.61.172 -p 5003 -i 533e0ea9-4155-11eb-93fb-04ea56f99520 --seed 99132
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 52.151.70.54 -p 5005 -i 53460bdf-4155-11eb-93fb-04ea56f99520 --seed 898513
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 40.127.108.223 -p 5001 -i 533e0dd7-4155-11eb-93fb-04ea56f99520 --seed 438148
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 20.185.45.222 -p 5004 -i 533e0df5-4155-11eb-93fb-04ea56f99520 --seed 712546
python3 message_factory.py -r external
