...
# Launch orchestrator
python3 orchestrator_script.py -i 1 -e 3 -h '127.0.0.1' -p 4439 -r 276529 -a 2 &
...
python3 vnf_script.py -i 0 -o 1 -e 3 -h '127.0.0.1' -p 3011 &
python3 vnf_script.py -i 1 -o 1 -e 3 -h '127.0.0.1' -p 3012 &
python3 vnf_script.py -i 2 -o 1 -e 3 -h '127.0.0.1' -p 3013 &
python3 vnf_script.py -i 3 -o 1 -e 3 -h '127.0.0.1' -p 3014 &
python3 vnf_script.py -i 4 -o 1 -e 3 -h '127.0.0.1' -p 3015 &
python3 vnf_script.py -i 5 -o 1 -e 3 -h '127.0.0.1' -p 3016 &
python3 vnf_script.py -i 6 -o 1 -e 3 -h '127.0.0.1' -p 3017 &
python3 vnf_script.py -i 7 -o 1 -e 3 -h '127.0.0.1' -p 3018 &
python3 vnf_script.py -i 8 -o 1 -e 3 -h '127.0.0.1' -p 3019 &
python3 vnf_script.py -i 9 -o 1 -e 3 -h '127.0.0.1' -p 3020 &
