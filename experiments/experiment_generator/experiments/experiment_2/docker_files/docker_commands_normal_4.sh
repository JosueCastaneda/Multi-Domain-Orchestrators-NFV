...
# Launch orchestrator
python orchestrator_script_normal.py -i 4 -e 2 -h '0.0.0.0' -p 5005 -r 1950 &
...
# Request scaling 
python message_factory.py -t request_scaling_of_service -h 52.229.37.237 -p 5002 -i 5f8fb9f4-1dcd-11eb-9945-525400e0bd2a --seed 13796
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 52.151.70.54 -p 5005 -i 5f944f6a-1dcd-11eb-9945-525400e0bd2a --seed 55767
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 52.141.61.172 -p 5003 -i 5f944f82-1dcd-11eb-9945-525400e0bd2a --seed 52888
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 20.185.45.222 -p 5004 -i 5f944de2-1dcd-11eb-9945-525400e0bd2a --seed 97863
python3 message_factory.py -r external
python message_factory.py -t request_scaling_of_service -h 40.127.108.223 -p 5001 -i 5f944e2c-1dcd-11eb-9945-525400e0bd2a --seed 76860
python3 message_factory.py -r external
