...
# Launch orchestrator
python orchestrator_script.py -i 2 -e 7 -h '127.0.0.1' -p 4441 -r 276529 -a 0 &
...
python vnf_script.py -i 0 -o 2 -e 7 -h '127.0.0.1' -p 3021 &
python vnf_script.py -i 1 -o 2 -e 7 -h '127.0.0.1' -p 3022 &
python vnf_script.py -i 2 -o 2 -e 7 -h '127.0.0.1' -p 3023 &
python vnf_script.py -i 3 -o 2 -e 7 -h '127.0.0.1' -p 3024 &
python vnf_script.py -i 4 -o 2 -e 7 -h '127.0.0.1' -p 3025 &
python vnf_script.py -i 5 -o 2 -e 7 -h '127.0.0.1' -p 3026 &
python vnf_script.py -i 6 -o 2 -e 7 -h '127.0.0.1' -p 3027 &
python vnf_script.py -i 7 -o 2 -e 7 -h '127.0.0.1' -p 3028 &
python vnf_script.py -i 8 -o 2 -e 7 -h '127.0.0.1' -p 3029 &
python vnf_script.py -i 9 -o 2 -e 7 -h '127.0.0.1' -p 3030 &
