...
# Launch orchestrator
python orchestrator_script_normal.py -i 1 -e 34 -h '0.0.0.0' -p 5002 -r 34374 &
...
python vnf_script.py -i 0 -o 1 -e 34 -h '0.0.0.0' -p 3001 &
python vnf_script.py -i 1 -o 1 -e 34 -h '0.0.0.0' -p 3002 &
python vnf_script.py -i 2 -o 1 -e 34 -h '0.0.0.0' -p 3003 &
python vnf_script.py -i 3 -o 1 -e 34 -h '0.0.0.0' -p 3004 &
python vnf_script.py -i 4 -o 1 -e 34 -h '0.0.0.0' -p 3005 &
python vnf_script.py -i 5 -o 1 -e 34 -h '0.0.0.0' -p 3006 &
python vnf_script.py -i 6 -o 1 -e 34 -h '0.0.0.0' -p 3007 &
python vnf_script.py -i 7 -o 1 -e 34 -h '0.0.0.0' -p 3008 &
python vnf_script.py -i 8 -o 1 -e 34 -h '0.0.0.0' -p 3009 &
python vnf_script.py -i 9 -o 1 -e 34 -h '0.0.0.0' -p 3010 &
