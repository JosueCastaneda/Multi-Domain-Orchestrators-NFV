...
vim-emu compute start -d dc1 -n orch_1 --image vnf_experiment --net '(id=output,ip=10.0.0.30/24)'
vim-emu compute start -d dc2 -n orch_2 --image vnf_experiment --net '(id=output,ip=10.0.0.32/24)'
vim-emu compute start -d dc2 -n orch_3 --image vnf_experiment --net '(id=output,ip=10.0.0.34/24)'
vim-emu compute start -d dc1 -n orch_4 --image vnf_experiment --net '(id=output,ip=10.0.0.36/24)'
...
#vim-emu compute start -d dc4 -n vnf37_speed --image vnf_experiment --net '(id=input,ip=10.0.0.105/24)'
...
vim-emu compute start -d dc2 -n vnf29_painting --image vnf_experiment --net '(id=input,ip=10.0.0.49/24)'
vim-emu compute start -d dc2 -n vnf37_speed --image vnf_experiment --net '(id=input,ip=10.0.0.105/24)'
