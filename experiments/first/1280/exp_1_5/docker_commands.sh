...
docker exec -it mn.vnf37_speed python vnf_script.py -h 10.0.0.105 -v 4437 -o 10.0.0.36 -q 5467 -n speed --topology 0.1770,0,0,0 --initial 114 &
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.51 -p 4437 -n none -m none -v 10.0.0.52 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.52 -p 4437 -n none -m none -v 10.0.0.54 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.54 -p 4437 -n none -m none -v 10.0.0.105 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.105 -p 4437 -n none -m none -v 10.0.0.53 --vnf_port 4437

# Add VNFs to service 2
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.53 -p 4437 -n none -m none -v 10.0.0.104 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.104 -p 4437 -n none -m none -v 10.0.0.46 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.46 -p 4437 -n none -m none -v 10.0.0.48 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.48 -p 4437 -n none -m none -v 10.0.0.49 --vnf_port 4437
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.49 -p 4437 -n none -m none -v 10.0.0.55 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.55 -p 4437 -n none -m none -v 10.0.0.52 --vnf_port 4437
