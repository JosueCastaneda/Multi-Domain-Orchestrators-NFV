...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.17 -p 4437 -n none -m none -v 10.0.0.21 --vnf_port 4451
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.100 -p 4437 -n none -m none -v 10.0.0.16 --vnf_port 4441
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.16 -p 4437 -n none -m none -v 10.0.0.13 --vnf_port 4433

# Add VNFs to service 3
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.18 -p 4437 -n none -m none -v 10.0.0.19 --vnf_port 4447
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.19 -p 4437 -n none -m none -v 10.0.0.17 --vnf_port 4443
