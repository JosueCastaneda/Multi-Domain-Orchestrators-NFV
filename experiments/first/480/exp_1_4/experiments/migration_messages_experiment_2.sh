...
docker exec -it mn.vnf_CROP_new python vnf_script.py -h 10.0.0.182 -v 4437 -o 10.0.0.32 -q 5461 -n vnf_CROP_new --topology 15,40,7,4 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 246 &
...
docker exec -it mn.vnf_RESIZE_new python vnf_script.py -h 10.0.0.195 -v 4437 -o 10.0.0.30 -q 5461 -n vnf_RESIZE_new --topology 5,66,10,6 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 285 &
docker exec -it mn.vnf_BLACK_WHITE_new python vnf_script.py -h 10.0.0.251 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_BLACK_WHITE_new --topology 4,48,5,3 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 453 &
docker exec -it mn.vnf_ANNOTATE_new python vnf_script.py -h 10.0.0.238 -v 4437 -o 10.0.0.30 -q 5461 -n vnf_ANNOTATE_new --topology 8,7,9,9 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 414 &
docker exec -it mn.vnf_MIRROR_X_new python vnf_script.py -h 10.0.0.233 -v 4437 -o 10.0.0.30 -q 5461 -n vnf_MIRROR_X_new --topology 15,6,1,1 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 399 &
docker exec -it mn.vnf_INVERT_COLORS_new python vnf_script.py -h 10.0.0.217 -v 4437 -o 10.0.0.32 -q 5461 -n vnf_INVERT_COLORS_new --topology 4,50,0,7 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 351 &
docker exec -it mn.vnf_FADE_OUT_new python vnf_script.py -h 10.0.0.153 -v 4437 -o 10.0.0.32 -q 5461 -n vnf_FADE_OUT_new --topology 17,13,9,3 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 159 &
docker exec -it mn.vnf_SPEED_UP_new python vnf_script.py -h 10.0.0.209 -v 4437 -o 10.0.0.30 -q 5461 -n vnf_SPEED_UP_new --topology 4,11,5,10 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 327 &
docker exec -it mn.vnf_FADE_IN_new python vnf_script.py -h 10.0.0.249 -v 4437 -o 10.0.0.34 -q 5461 -n vnf_FADE_IN_new --topology 1,19,6,10 --migration_ip 127.0.0.1 --migration_topology 0,0,0,0 --services 0,236,12,40,60,124,24,32,24,208,16,8 --initial 447 &
