...
docker exec -it mn.vnf_ROTATE  python vnf_script.py -h 10.0.0.13 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_ROTATE  --topology 15,22,0,4 --migration_ip 10.0.0.229 --migration_topology 9,18,2,7 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 1 &
docker exec -it mn.vnf_CROP  python vnf_script.py -h 10.0.0.12 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_CROP  --topology 0,45,6,0 --migration_ip 10.0.0.182 --migration_topology 15,40,7,4 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 4 &
...
docker exec -it mn.vnf_BLACK_WHITE  python vnf_script.py -h 10.0.0.20 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_BLACK_WHITE  --topology 5,25,1,3 --migration_ip 10.0.0.251 --migration_topology 4,48,5,3 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 13 &
docker exec -it mn.vnf_ANNOTATE  python vnf_script.py -h 10.0.0.18 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_ANNOTATE  --topology 14,44,8,5 --migration_ip 10.0.0.238 --migration_topology 8,7,9,9 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 16 &
docker exec -it mn.vnf_MIRROR_X  python vnf_script.py -h 10.0.0.17 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_MIRROR_X  --topology 16,32,7,1 --migration_ip 10.0.0.233 --migration_topology 15,6,1,1 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 19 &
...
docker exec -it mn.vnf_FADE_OUT  python vnf_script.py -h 10.0.0.19 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_FADE_OUT  --topology 13,11,3,5 --migration_ip 10.0.0.153 --migration_topology 17,13,9,3 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 25 &
docker exec -it mn.vnf_SPEED_UP  python vnf_script.py -h 10.0.0.68 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_SPEED_UP  --topology 16,46,2,5 --migration_ip 10.0.0.209 --migration_topology 4,11,5,10 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 28 &
docker exec -it mn.vnf_FADE_IN  python vnf_script.py -h 10.0.0.14 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_FADE_IN  --topology 8,69,1,4 --migration_ip 10.0.0.249 --migration_topology 1,19,6,10 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 31 &
docker exec -it mn.vnf_COMPOSITE  python vnf_script.py -h 10.0.0.100 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_COMPOSITE  --topology 10,39,2,1 --migration_ip 10.0.0.181 --migration_topology 4,58,9,2 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 34 &
docker exec -it mn.vnf_MIRROR_Y  python vnf_script.py -h 10.0.0.16 -v 4437 -o 10.0.0.36 -q 5461 -n vnf_MIRROR_Y  --topology 20,19,4,7 --migration_ip 10.0.0.156 --migration_topology 4,16,0,0 --services 55,305,30,15,15,200,15,35,55,135,20,5,95,160,40,5,60,215,20,30,75,50,30,35,5,110,45,25,95,90,30,15,95,295,10,0,55,315,35,45 --initial 37 &
