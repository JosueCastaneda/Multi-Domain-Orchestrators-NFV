...
docker exec -it mn.vnf38_crop python vnf_script.py -h 10.0.0.56 -v 4437 -o 10.0.0.30 -q 5461 -n crop --topology 0.2529,0,0,0 --initial 117 &
...
docker exec -it mn.vnf47_black_white python vnf_script.py -h  -v 4437 -o 10.0.0.36 -q 5467 -n black_white --topology 0.3009,0,0,0 --initial 144 &
docker exec -it mn.vnf50_speed python vnf_script.py -h 10.0.0.107 -v 4437 -o 10.0.0.36 -q 5467 -n composite_stadium --topology 0.2608,0,0,0 --initial 153 &
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.64 -p 4437 -n none -m none -v 10.0.0.59 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.59 -p 4437 -n none -m none -v 10.0.0.62 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.62 -p 4437 -n none -m none -v 10.0.0.57 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.57 -p 4437 -n none -m none -v 10.0.0.60 --vnf_port 4437
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.66 -p 4437 -n none -m none -v 10.0.0.56 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.56 -p 4437 -n none -m none -v 10.0.0.63 --vnf_port 4437
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.106 -p 4437 -n none -m none -v 10.0.0.107 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.107 -p 4437 -n none -m none -v 10.0.0.60 --vnf_port 4437
...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.65 -p 4437 -n none -m none -v 10.0.0.62 --vnf_port 4437
