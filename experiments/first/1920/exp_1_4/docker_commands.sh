...
docker exec -it mn.vnf47_black_white /bin/bash
python vnf_script.py -h 10.0.0.65 -v 4437 -o 10.0.0.36 -q 5467 -n black_white --topology 0.3009,0,0,0 --initial 144
...
docker exec -it mn.vnf38_crop /bin/bash
python vnf_script.py -h 10.0.0.56 -v 4437 -o 10.0.0.30 -q 5461 -n crop --topology 0.2529,0,0,0 --initial 117
...
docker exec -it mn.vnf40_resize python vnf_script.py -h 10.0.0.58 -v 4437 -o 10.0.0.30 -q 5461 -n resize --topology 0.2947,0,0,0 --initial 123 &
