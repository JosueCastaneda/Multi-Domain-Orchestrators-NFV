...
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.29 -p 4437 -n none -m none -v 10.0.0.40 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.40 -p 4437 -n none -m none -v 10.0.0.42 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.42 -p 4437 -n none -m none -v 10.0.0.103 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.103 -p 4437 -n none -m none -v 10.0.0.41 --vnf_port 4437

# Add VNFs to service 2
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.41 -p 4437 -n none -m none -v 10.0.0.102 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.102 -p 4437 -n none -m none -v 10.0.0.24 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.24 -p 4437 -n none -m none -v 10.0.0.26 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.26 -p 4437 -n none -m none -v 10.0.0.27 --vnf_port 4437

# Add VNFs to service 3
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.103 -p 4437 -n none -m none -v 10.0.0.27 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.27 -p 4437 -n none -m none -v 10.0.0.43 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.43 -p 4437 -n none -m none -v 10.0.0.40 --vnf_port 4437
docker exec -it mn.source python message_factory.py -t add_chain -h 10.0.0.40 -p 4437 -n none -m none -v 10.0.0.28 --vnf_port 4437
